...
public class BlockPanel extends JPanel {
  ...
  public static String circle = I18N.JUMP.get("deejump.ui.style.RenderingStylePanel.circle");
  public static String triangle = I18N.JUMP.get("deejump.ui.style.RenderingStylePanel.triangle");
  public static String square = I18N.JUMP.get("deejump.ui.style.RenderingStylePanel.square");
  public static String cross = I18N.JUMP.get("deejump.ui.style.RenderingStylePanel.cross");
  public static String star = I18N.JUMP.get("deejump.ui.style.RenderingStylePanel.star");
  ...
  public JPanel panel_blocks(PlugInContext context) throws Exception {
    ...
    final Dimension d = new Dimension(140, /*
                                            ...
                                            * height
                                            */28);
    chooseBox.setToolTipText(CadExtension.I18N.get("org.openjump.core.ui.plugins.block.dialog.select-block"));
    ...
    labelRotation
        .setToolTipText(CadExtension.I18N.get("org.openjump.core.ui.plugins.annotation.dialog.font-rotation-message"));
  ...
  private JPanel getBlockChooserPanel(PlugInContext context) {
    ...
    blockChooserPanel
        .setToolTipText(CadExtension.I18N.get("org.openjump.core.ui.plugins.block.dialog.dialog.select-block-message"));
  ...
  public Geometry getSelection() {
    return chooseBox.getSelectedItem() == null ? null : ((BlockCell) chooseBox.getSelectedItem()).getGeometry().copy();
  }
  ...
  private String gedDimensionTooltip() {
    ...
    return String.format("<HTML><BODY><DIV style=\"%s\"><b>%s</b><br>%s</DIV></BODY></HTML>", style, dimension,
        description);
  }
