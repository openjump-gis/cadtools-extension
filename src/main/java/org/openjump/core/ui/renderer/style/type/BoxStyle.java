...
public class BoxStyle extends ExtendedDecorationStyle {
    private final static double SMALL_ANGLE = 10;
    private final static double MEDIUM_ANGLE = 45;
     ...
     *            pixels
     */
    public BoxStyle(String name, String iconFile, double finAngle,
    ...
    public static class Small extends BoxStyle {
        public Small() {
            super("Geo 8", "geo8.png", MEDIUM_ANGLE, MEDIUM_LENGTH, true);
        }
    }

    public static class Solid extends BoxStyle {
        public Solid() {
            super("Geo 7b", "geo6a.png", MEDIUM_ANGLE, MEDIUM_LENGTH, true);
        }
    }

    public static class NarrowSolid extends BoxStyle {
        public NarrowSolid() {
            super("Geo 7c", "geo6a.png", SMALL_ANGLE, LARGE_LENGTH, true);
        }
    }
