...
public class SynclineStyle extends ExtendedDecorationStyle {
     ...
     *            pixels
     */
    public SynclineStyle(String name, String iconFile, double finAngle,
    ...
    public static class Small extends SynclineStyle {
        public Small() {
            super("Geo 6a", "geo6a.png", MEDIUM_ANGLE, MEDIUM_LENGTH, true);
        }
    }

    public static class Solid extends SynclineStyle {
        public Solid() {
            super("Geo 6a", "geo6a.png", MEDIUM_ANGLE, MEDIUM_LENGTH, true);
        }
    }

    public static class NarrowSolid extends SynclineStyle {
        public NarrowSolid() {
            super("Geo 6a", "geo6a.png", SMALL_ANGLE, LARGE_LENGTH, true);
        }
    }
