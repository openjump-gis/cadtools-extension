...
public class ExtendLinePlugIn extends AbstractPlugIn {
    ...
    protected ExtendToDrawnLineTool etdlt = null;
    protected ExtendToClickedGeometryTool etcgt = null;
    ...
    protected void createTools() {
        elt = new ExtendRectLineTool();// Extend selected linestringto the
                                       // nearest geometry
        etdlt = new ExtendToDrawnLineTool();// Draw a segment to extend selected
                                            // linestring
