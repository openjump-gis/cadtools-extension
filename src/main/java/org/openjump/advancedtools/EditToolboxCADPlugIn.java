...
public class EditToolboxCADPlugIn extends ToolboxPlugInV2 {

  private static final I18N i18n = CadExtension.I18N;

  public static final String CAD = i18n.get("org.openjump.core.ui.CAD");
  public static final String CAD_OPTIONS_PANE_NAME = i18n.get("org.openjump.core.ui.config.CADToolsOptionsPanel");
  ...
  protected ToolboxDialog initializeToolbox() throws Exception {
    ...
    EnableCheckFactory checkFactory = JUMPWorkbench.getInstance().getContext().createPlugInContext().getCheckFactory();
    ...
    cogoCommandButton.addItemListener(e -> frame.setVisible(cogoCommandButton.isSelected()));
    ...
    toolbox.validate();
    toolbox.setInitialLocation(new GUIUtil.Location(40, true, 40, true));
  ...
  private JPanel optionPanel(final ToolboxDialog toolbox) {
    ...
    optionsButton.setIcon(com.vividsolutions.jump.workbench.ui.images.IconLoader.icon("fugue/wrench-screwdriver.png"));
   ...
   */
  private JPanel FullPanel(final ToolboxDialog toolbox) throws Exception {
