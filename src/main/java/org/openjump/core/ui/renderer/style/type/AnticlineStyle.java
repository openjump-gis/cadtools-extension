...
public class AnticlineStyle extends ExtendedDecorationStyle {
     ...
     *            pixels
     */
    public AnticlineStyle(String name, String iconFile, double finAngle,
    ...
    private GeneralPath arrowhead(Point2D p0, Point2D p1, double finLength,
        ...
        path.lineTo((float) finTip1.getX(), (float) finTip1.getY());
    ...
    public static class Close extends AnticlineStyle {
        public Close() {
            super("Geo 5a", "geo5a.png", MEDIUM_ANGLE, MEDIUM_LENGTH, true);
        }
    }

    public static class Open extends AnticlineStyle {
        public Open() {
            super("Geo 5b", "geo5b.png", MEDIUM_ANGLE, MEDIUM_LENGTH, false);
        }
    }
